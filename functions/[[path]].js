...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-CbJ78UXH.js");
...
const manifest = {
  "453e3685e2009543c71d4e734c7493ef9f0bf1569e10a2615163dcd9c906a232": {
    functionName: "getAISchemes_createServerFn_handler",
    importer: () => import("./assets/schemes-D_w-_Ike.js")
  },
  "8b2b791de38b4fe7d6e5f76e53cfc6462e79404e5a58490d3e58ad62448559b9": {
    functionName: "fetchLiveMandiPrices_createServerFn_handler",
    importer: () => import("./assets/mandi-BhmpR9Pf.js")
  },
  "7a0930bf3d609a5d36ab753fbcb89eeebfafb274e3db2ff09735671fe829aa28": {
    functionName: "geocodeCity_createServerFn_handler",
    importer: () => import("./assets/mandi-BhmpR9Pf.js")
  },
  "b16ed1540eb3a15d6982d4e3c4e0e0344181a053c347f4f3921e3366c6e39dc9": {
    functionName: "analyzeWithGemini_createServerFn_handler",
    importer: () => import("./assets/gemini-7mCXC5fw.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./assets/router-B23tt4C4.js").then((n) => n.r),
